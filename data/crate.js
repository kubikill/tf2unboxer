...
cA[143].loot = { // summer 2020 cosmetics
    i1: new Item(1549, 780, 4, 3),
    i2: new Item(1550, 780, 4, 3),
    i3: new Item(1551, 780, 10, 3),
    i4: new Item(1552, 780, 4, 3),
    i5: new Item(1553, 780, 10, 3),
    i6: new Item(1554, 780, 4, 3), //
    i7: new Item(1555, 780, 10, 3),
    i8: new Item(1556, 780, 10, 3),
    i9: new Item(1557, 780, 10, 3),
    i10: new Item(1558, 780, 10, 3),
    i11: new Item(1559, 250, 4, 4),
    i12: new Item(1560, 250, 4, 4),
    i13: new Item(1561, 250, 10, 4),
    i14: new Item(1562, 250, 4, 4), //
    i15: new Item(1563, 250, 10, 4),
    i16: new Item(1564, 250, 4, 4),
    i17: new Item(1565, 125, 10, 5),
    i18: new Item(1566, 125, 4, 5),
    i19: new Item(1567, 125, 4, 5),
    i20: new Item(1568, 125, 10, 5),
    i21: new Item(1569, 50, 10, 6),
    i22: new Item(1570, 50, 4, 6),
    i23: new Item(0, 100, 1),
};
cA[144].loot = { // hw 2020 cosmetics
    i1: new Item(1571, 780, 10, 3),
    i2: new Item(1572, 780, 4, 3),
    i3: new Item(1573, 780, 10, 3),
    i4: new Item(1574, 780, 4, 3),
    i5: new Item(1575, 780, 10, 3),
    i6: new Item(1576, 780, 10, 3), //
    i7: new Item(1577, 780, 4, 3),
    i8: new Item(1578, 780, 10, 3),
    i9: new Item(1579, 780, 4, 3),
    i10: new Item(1580, 780, 4, 3),
    i11: new Item(1581, 250, 10, 4),
    i12: new Item(1582, 250, 4, 4),
    i13: new Item(1583, 250, 4, 4),
    i14: new Item(1584, 250, 10, 4), //
    i15: new Item(1585, 250, 4, 4),
    i16: new Item(1586, 250, 10, 4),
    i17: new Item(1587, 125, 4, 5),
    i18: new Item(1588, 125, 10, 5),
    i19: new Item(1589, 125, 10, 5),
    i20: new Item(1590, 125, 10, 5),
    i21: new Item(1591, 50, 4, 6),
    i22: new Item(1592, 50, 10, 6),
    i23: new Item(0, 100, 1),
};
cA[145].loot = { // hw 2020 war paints
    i1: new Item(1593, 1143, 6, 3),
    i2: new Item(1594, 1143, 6, 3),
    i3: new Item(1595, 1143, 6, 3),
    i4: new Item(1596, 1143, 6, 3),
    i5: new Item(1597, 1143, 6, 3),
    i6: new Item(1598, 1143, 6, 3),
    i7: new Item(1599, 1143, 6, 3),
    i8: new Item(1600, 375, 6, 4),
    i9: new Item(1601, 375, 6, 4),
    i10: new Item(1602, 375, 6, 4),
    i11: new Item(1603, 375, 6, 4),
    i12: new Item(1604, 133, 6, 5),
    i13: new Item(1605, 133, 6, 5),
    i14: new Item(1606, 133, 6, 5),
    i15: new Item(1607, 100, 6, 6),
};