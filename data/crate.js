...
const hw11FX = [36, 37, 38, 39]
const hw12FX = [40, 41, 42, 43, 44];
const hw13FX = [62, 63, 64, 65, 66, 67, 68, 69];
const hw14FX = [70, 71, 72, 73, 74, 75];
const hw15FX = [89, 90, 91, 92, 93, 94, 95];
const hw16FX = [96, 97, 98, 99];
const hw17FX = hw11FX.concat(hw12FX, hw13FX, hw14FX, hw15FX, hw16FX);
const hw18FX = [100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110];
const hw19FX = [111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122];
const hw20FX = [143, 144, 145, 146, 147, 148, 149, 150];
...
const strangePartBonusArray = [256, 257, 258, 262, 263, 264, 269, 270, 272, 273, 274, 278, 279, 280, 298, 299, 300, 313, 314, 315, 367, 368, 369, 373, 374, 380, 381, 382, 446, 447, 453, 529, 530, 658, 659, 660, 663, 664, 665, 669, 670, 671, 760, 761, 833, 834, 961, 962, 963];
// List of Unlocked Creepy Crate bonus items
const creepyCrateBonusArray = [
    {id: 1652, quality: 12},
    {id: 1653, quality: 12},
    {id: 1654, quality: 12},
    {id: 1655, quality: 12},
...
const steamMarketWhitelist = [772, 773, 774, 775, 318, 212, 213, 214, 215, 216, 217, 218, 219, 220, 221, 345, 346, 347, 348, 349, 350, 351, 352, 353, 673, 674, 675, 676, 677, 678, 679, 680, 681, 922, 923, 924, 925, 926, 927, 928];
// List of crates affected by specific Halloween events
let halloweenModeCrateList = {};
...
let cA = [
    ...
    new Crate({ id: 14, series: 58, effects: roboFX, note: 7, unusual: 3, autoChance: 2, exclusiveBonus: {loot: [1665], chance: 1000}}),
...
cA[57].loot = [
    ...
    new Item({ id: 387, quality: 7 }),
    new Item({ id: 388, quality: 7 }),
    new Item({ id: 389, quality: 7 }),
    new Item({ id: 390, quality: 7 }),
    new Item({ id: 391, quality: 1 }),
    new Item({ id: 392, quality: 7 }),
    new Item({ id: 393, quality: 7 }),
    new Item({ id: 394, quality: 7 }),
    new Item({ id: 395, quality: 7 }),
    new Item({ id: 396, quality: 1 }),
    new Item({ id: 397, quality: 7 }),
    new Item({ id: 398, quality: 1 }),
    new Item({ id: 399, quality: 7 }),
    new Item({ id: 400, quality: 7 }),
    new Item({ id: 401, quality: 7 }),
    new Item({ id: 402, quality: 7 }),
    new Item({ id: 403, quality: 1 }),
    new Item({ id: 404, quality: 1 }),
    new Item({ id: 405, quality: 7 }),
    new Item({ id: 406, quality: 1 }),
    new Item({ id: 407, quality: 7 }),
    new Item({ id: 408, quality: 7 }),
    new Item({ id: 409, quality: 7 }),
    new Item({ id: 410, quality: 1 }),
    new Item({ id: 411, quality: 7 }),
    new Item({ id: 412, quality: 1 }),
    new Item({ id: 413, quality: 7 }),
    new Item({ id: 414, quality: 7 }),
    new Item({ id: 415, quality: 7 }),
    new Item({ id: 416, quality: 1 }),
    new Item({ id: 417, quality: 7 }),
    new Item({ id: 418, quality: 7 }),
    new Item({ id: 419, quality: 1 }),
    new Item({ id: 420, quality: 7 }),
    new Item({ id: 421, quality: 1 }),
    new Item({ id: 422, quality: 7 }),
    new Item({ id: 423, quality: 7 }),
    new Item({ id: 424, quality: 1 }),
    new Item({ id: 425, quality: 7 }),
    new Item({ id: 426, quality: 1 }),
    new Item({ id: 427, quality: 7 }),
    new Item({ id: 428, quality: 1 }),
    new Item({ id: 429, quality: 1 }),
    new Item({ id: 430, quality: 7 }),
    new Item({ id: 431, quality: 7 }),
    new Item({ id: 432, quality: 7 }),
    new Item({ id: 433, quality: 7 }),
    new Item({ id: 434, quality: 7 }),
    new Item({ id: 435, quality: 7 }),
    new Item({ id: 436, quality: 7 }),
    new Item({ id: 437, quality: 1 }),
    new Item({ id: 438, quality: 7 }),
    new Item({ id: 439, quality: 7 }),
    new Item({ id: 440, quality: 7 }),
    new Item({ id: 441, quality: 7 }),
