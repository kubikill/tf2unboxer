...
export let cA = [
    ...
    new Crate({ id: 97, series: 139, effects: xmas22FX.concat(allGensFX), note: 5, unusual: 2, autoChance: 1, bonus: true }),
    ...
    new Crate({ id: 100, series: 142, effects: hw23FX, note: 5, unusual: 2, autoChance: 1, bonus: true, exclusiveBonus: { loot: [1951, 1952, 1953, 1954], chance: 5000} }), 
];
