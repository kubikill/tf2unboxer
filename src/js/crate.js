...
// Unusual item pools shared between crates
...
export const xmas24FX = [319, 320, 321, 322, 323, 324, 325, 326];
export const xmas25FX = [341, 342, 343, 344, 345, 346, 347, 348, 349, 350, 351];
...
export const summer25FX = [327, 328, 329, 330, 331, 332, 333];
export const summer26FX = [352, 353, 354, 355, 356, 357, 358];
...
halloweenModeCrateList.hw24 = halloweenModeCrateList.summer24.concat([159]);
halloweenModeCrateList.xmas24 = halloweenModeCrateList.hw24.concat([160]);
halloweenModeCrateList.summer25 = halloweenModeCrateList.xmas24.concat([162]);
...
cA[162].loot = [ // winter 2024 cosmetic case
    new Item({ id: 2050, quality: 4, grade: 3 }),
    new Item({ id: 2051, quality: 4, grade: 3 }),
    new Item({ id: 2052, quality: 4, grade: 3 }),
    new Item({ id: 2053, quality: 4, grade: 3 }),
    new Item({ id: 2054, quality: 10, grade: 3 }),
    new Item({ id: 2055, quality: 4, grade: 3 }),
    new Item({ id: 2056, quality: 4, grade: 3 }),
    new Item({ id: 2057, quality: 10, grade: 3 }),
    new Item({ id: 2058, quality: 4, grade: 3 }),
    new Item({ id: 2059, quality: 10, grade: 3 }),
    new Item({ id: 2060, quality: 10, grade: 4 }),
    new Item({ id: 2061, quality: 4, grade: 4 }),
    new Item({ id: 2062, quality: 4, grade: 4 }),
    new Item({ id: 2063, quality: 10, grade: 4 }),
    new Item({ id: 2064, quality: 4, grade: 4 }),
    new Item({ id: 2065, quality: 10, grade: 4 }),
    new Item({ id: 2066, quality: 4, grade: 4 }),
    new Item({ id: 2067, quality: 4, grade: 4 }),
    new Item({ id: 2068, quality: 4, grade: 5 }),
    new Item({ id: 2069, quality: 10, grade: 5 }),
    new Item({ id: 2070, quality: 4, grade: 5 }),
    new Item({ id: 2071, quality: 10, grade: 5 }),
    new Item({ id: 2072, quality: 10, grade: 6 }),
];
cA[163].loot = [ // summer 2025 cosmetic case
    new Item({ id: 2076, quality: 4, grade: 3 }),
    new Item({ id: 2077, quality: 10, grade: 3 }),
    new Item({ id: 2078, quality: 4, grade: 3 }),
    new Item({ id: 2079, quality: 10, grade: 3 }),
    new Item({ id: 2080, quality: 4, grade: 3 }),
    new Item({ id: 2081, quality: 10, grade: 3 }),
    new Item({ id: 2082, quality: 4, grade: 3 }),
    new Item({ id: 2083, quality: 4, grade: 3 }),
    new Item({ id: 2084, quality: 10, grade: 3 }),
    new Item({ id: 2085, quality: 4, grade: 3 }),
    new Item({ id: 2086, quality: 4, grade: 4 }),
    new Item({ id: 2087, quality: 10, grade: 4 }),
    new Item({ id: 2088, quality: 4, grade: 4 }),
    new Item({ id: 2089, quality: 4, grade: 4 }),
    new Item({ id: 2090, quality: 4, grade: 4 }),
    new Item({ id: 2091, quality: 4, grade: 4 }),
    new Item({ id: 2092, quality: 10, grade: 4 }),
    new Item({ id: 2093, quality: 4, grade: 4 }),
    new Item({ id: 2094, quality: 4, grade: 5 }),
    new Item({ id: 2095, quality: 10, grade: 5 }),
    new Item({ id: 2096, quality: 10, grade: 5 }),
    new Item({ id: 2097, quality: 4, grade: 5 }),
    new Item({ id: 2098, quality: 10, grade: 6 }),
];
cA[164].loot = [ // halloween 2025 case
    new Item({ id: 2103, quality: 10, grade: 3 }),
    new Item({ id: 2104, quality: 10, grade: 3 }),
    new Item({ id: 2105, quality: 10, grade: 3 }),
    new Item({ id: 2106, quality: 4, grade: 3 }),
    new Item({ id: 2107, quality: 4, grade: 3 }),
    new Item({ id: 2108, quality: 10, grade: 3 }),
    new Item({ id: 2109, quality: 4, grade: 3 }),
    new Item({ id: 2110, quality: 4, grade: 3 }),
    new Item({ id: 2111, quality: 4, grade: 3 }),
    new Item({ id: 2112, quality: 4, grade: 3 }),
    new Item({ id: 2113, quality: 4, grade: 4 }),
    new Item({ id: 2114, quality: 4, grade: 4 }),
    new Item({ id: 2115, quality: 4, grade: 4 }),
    new Item({ id: 2116, quality: 4, grade: 4 }),
    new Item({ id: 2117, quality: 4, grade: 4 }),
    new Item({ id: 2118, quality: 4, grade: 4 }),
    new Item({ id: 2119, quality: 10, grade: 4 }),
    new Item({ id: 2120, quality: 10, grade: 5 }),
    new Item({ id: 2121, quality: 4, grade: 5 }),
    new Item({ id: 2122, quality: 10, grade: 5 }),
    new Item({ id: 2123, quality: 4, grade: 5 }),
    new Item({ id: 2124, quality: 4, grade: 6 }),
    new Item({ id: 2125, quality: 10, grade: 6 }),
];
cA[165].loot = [ // winter 2025 cosmetic case
    new Item({ id: 2133, quality: 4, grade: 3 }),
    new Item({ id: 2134, quality: 4, grade: 3 }),
    new Item({ id: 2135, quality: 4, grade: 3 }),
    new Item({ id: 2136, quality: 4, grade: 3 }),
    new Item({ id: 2137, quality: 10, grade: 3 }),
    new Item({ id: 2138, quality: 4, grade: 3 }),
    new Item({ id: 2139, quality: 10, grade: 3 }),
    new Item({ id: 2140, quality: 4, grade: 3 }),
    new Item({ id: 2141, quality: 4, grade: 3 }),
    new Item({ id: 2142, quality: 4, grade: 3 }),
    new Item({ id: 2143, quality: 4, grade: 4 }),
    new Item({ id: 2144, quality: 10, grade: 4 }),
    new Item({ id: 2145, quality: 10, grade: 4 }),
    new Item({ id: 2146, quality: 4, grade: 4 }),
    new Item({ id: 2147, quality: 10, grade: 4 }),
    new Item({ id: 2148, quality: 4, grade: 4 }),
    new Item({ id: 2149, quality: 10, grade: 4 }),
    new Item({ id: 2150, quality: 10, grade: 4 }),
    new Item({ id: 2151, quality: 10, grade: 5 }),
    new Item({ id: 2152, quality: 4, grade: 5 }),
    new Item({ id: 2153, quality: 4, grade: 5 }),
    new Item({ id: 2154, quality: 4, grade: 5 }),
    new Item({ id: 2155, quality: 10, grade: 6 }),
];
cA[166].loot = [ // summer 2026 cosmetic case
    new Item({ id: 2159, quality: 10, grade: 3 }),
    new Item({ id: 2160, quality: 4, grade: 3 }),
    new Item({ id: 2161, quality: 4, grade: 3 }),
    new Item({ id: 2162, quality: 4, grade: 3 }),
    new Item({ id: 2163, quality: 4, grade: 3 }),
    new Item({ id: 2164, quality: 10, grade: 3 }),
    new Item({ id: 2165, quality: 4, grade: 3 }),
    new Item({ id: 2166, quality: 10, grade: 3 }),
    new Item({ id: 2167, quality: 4, grade: 3 }),
    new Item({ id: 2168, quality: 4, grade: 3 }),
    new Item({ id: 2169, quality: 4, grade: 4 }),
    new Item({ id: 2170, quality: 10, grade: 4 }),
    new Item({ id: 2171, quality: 10, grade: 4 }),
    new Item({ id: 2172, quality: 4, grade: 4 }),
    new Item({ id: 2173, quality: 10, grade: 4 }),
    new Item({ id: 2174, quality: 4, grade: 4 }),
    new Item({ id: 2175, quality: 4, grade: 4 }),
    new Item({ id: 2176, quality: 4, grade: 4 }),
    new Item({ id: 2177, quality: 4, grade: 5 }),
    new Item({ id: 2178, quality: 4, grade: 5 }),
    new Item({ id: 2179, quality: 10, grade: 5 }),
    new Item({ id: 2180, quality: 10, grade: 5 }),
    new Item({ id: 2181, quality: 10, grade: 6 }),
    new Item({ id: 2182, quality: 4, grade: 6 }),
];
cA[167].loot = [ // summer 2026 war paints
    new Item({ id: 2183, quality: 6, grade: 3 }),
    new Item({ id: 2184, quality: 6, grade: 3 }),
    new Item({ id: 2185, quality: 6, grade: 3 }),
    new Item({ id: 2186, quality: 6, grade: 3 }),
    new Item({ id: 2187, quality: 6, grade: 4 }),
    new Item({ id: 2188, quality: 6, grade: 4 }),
    new Item({ id: 2189, quality: 6, grade: 4 }),
