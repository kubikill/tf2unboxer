...
export let cA = [
    ...
    new Crate({ id: 97, series: 139, effects: xmas22FX, note: 5, unusual: 2, autoChance: 1, bonus: true, exclusiveBonus: { loot: [972], chance: 4000 }, oneExclusiveBonus: true }),
];
